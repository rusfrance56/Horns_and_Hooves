...
INSERT INTO items (id, name, description, image_url, department, cost) VALUES
  (100007, 'Стенка Версаль', 'Версаль СБ-1655 Стенка', '/link/sfasfa/fasdf.jpg', 'STORAGE', 38490.90),
  (100008, 'Диван угловой', 'Диван угловой Атланта Классик со столом, 145, рогожка, дельфин', '/link/sfasfa/fasdf.jpg', 'CUSHIONED', 26080),
  (100009, 'Комод Медея', 'Медея СБ-2454 Комод', '/link/sfasfa/fasdf.jpg', 'STORAGE', 9490),
  (100017, 'Кухня Регина серия Mishel', 'Кухня Регина серия Mishel Беж песок/Ирландский ликер, Рустик серый 1,8-2,4 м (Мишель)', '/link/sfasfa/fasdf.jpg', 'STORAGE', 110856.00),
  (100018, 'Шкаф-купе', 'Терра СБ-2545 Шкаф-купе 2-х дверный', '/link/sfasfa/fasdf.jpg', 'STORAGE', 8590.00),
  (100019, 'Диван-кровать угловой', 'Диван-кровать угловой еврокнижка Модерн,велюр', '/link/sfasfa/fasdf.jpg', 'CUSHIONED', 42990.99),
  (100020, 'Шкаф 2-х дверный', 'Мамбо СБ-2371 Шкаф 2-х дверный', '/link/sfasfa/fasdf.jpg', 'STORAGE', 9890.00),
  (100021, 'Кухня Деми', 'Кухня Деми Белый / Дуб Сонома 1 м', '/link/sfasfa/fasdf.jpg', 'STORAGE', 9990),
  (100022, 'Стол-тумба', 'Мамбо СБ-2886 Стол-тумба', '/link/sfasfa/fasdf.jpg', 'OFFICE', 6890),
  (100023, 'Стенка Прадо', 'Стенка Прадо (Вегас) СБ-2224', '/link/sfasfa/fasdf.jpg', 'OFFICE', 19790);
